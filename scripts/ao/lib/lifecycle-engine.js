...
function buildActionTemplates(scope) {
  ...
  return {
    continue_worker: {
      ...
      commands: ['ao-pilot status --json', `ao-pilot runtime-project-get ${projectId} --json`],
    ...
    restore_worker: {
      ...
      commands: ['ao-pilot status --json', `ao-pilot runtime-project-get ${projectId} --json`, reconcileCommand],
    ...
    notify_human_ready: {
      ...
      commands: [
        ...
        'ao-pilot status --json',
        `ao-pilot runtime-project-get ${projectId} --json`,
      ],
